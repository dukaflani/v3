            ...
            <CardContent>
              <Stack spacing={1}>
                ...
                <Box sx={{width: '100%', paddingTop: 1}}>
                    <Button startIcon={<LocalActivityOutlinedIcon/>} onClick={() => router.push({ pathname: `/events/${event?.id}`, query: {a: videoUserID} }) } fullWidth variant='contained' size="small" >Event Details</Button>
                </Box>
              </Stack>
            </CardContent>
        </Card>
