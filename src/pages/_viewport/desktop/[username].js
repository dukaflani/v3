...
import ProfileUserInfo from '@/components/reusableComponents/ProfileUserInfo'
...
import ProfileUserTabs from '@/components/reusableComponents/ProfileUserTabs'
    ...
    <>
        <NavigationLayout2 setIsDarkMode={setIsDarkMode} isDarkMode={isDarkMode} >
            <Head>
                    ...
                    <meta name="title" content={`My profile on Dukaflani`} />
                    ...
                    <meta property="og:title" content={`My profile on Dukaflani`} />
            ...
            <Paper sx={{ minHeight: '100vh', paddingTop: 10}}>
                    {showProfile && <Container maxWidth="md">
                        <Stack spacing={1}>
                            <ProfileUserInfo profile={profile} />
                            <Grid container>
                                <Grid item xs={12} sm={6} md={4} sx={{paddingBottom: 2}}>
                                    <ProfileUserTabs profile={profile} />
                                </Grid>
                                <Grid item xs={12} sm={6} md={8} sx={{paddingLeft: 1.5}}>
                                    ...
                                    <ProfileUserItemsTabs profile={profile} />
                                </Grid>
                            </Grid>
                        </Stack>
